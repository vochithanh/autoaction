...
function autoactionMode() {
  ...
  var varNames = /[\w\-:]/;
  var keywords = buildRegexp([/begin|break|catch|continue|data|default|do|dynamicparam/, /else|elseif|end|exit|filter|finally|for|foreach|from|function|if|in/, /param|process|return|switch|throw|trap|try|until|where|while/, /Open|Click|Input|Search|Tab|Close|Area|Flag|Export|Table|Detect|Page|Fork/], {
